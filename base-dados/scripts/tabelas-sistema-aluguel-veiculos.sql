...
bandeira_cartao VARCHAR2(10) CHECK( bandeira_cartao IN ('VISA','MASTERCARD')),
validade VARCHAR2 (7),
limite NUMBER (10, 2)
);
...
disponibilidade VARCHAR2(11) CHECK( disponibilidade IN ('ALUGADO','DISPONÍVEL'))
);
...
INSERT INTO VEICULO (ID_VEICULO, MARCA, MODELO, COR, ANO, QUILOMETRAGEM, VALOR_LOCACAO_DIARIO, DISPONIBILIDADE)
VALUES (SEQ_VEICULO.nextval, 'Honda', 'Civic', 'Preto', 2019, 10000, 220, 'DISPONÍVEL');
INSERT INTO VEICULO (ID_VEICULO, MARCA, MODELO, COR, ANO, QUILOMETRAGEM, VALOR_LOCACAO_DIARIO, DISPONIBILIDADE)
VALUES (SEQ_VEICULO.nextval, 'Honda', 'Fit', 'Preto', 2020, 8000, 160, 'DISPONÍVEL');
INSERT INTO VEICULO (ID_VEICULO, MARCA, MODELO, COR, ANO, QUILOMETRAGEM, VALOR_LOCACAO_DIARIO, DISPONIBILIDADE)
VALUES (SEQ_VEICULO.nextval, 'Toyota', 'Corolla', 'Cinza', 2019, 12000, 220, 'DISPONÍVEL');
INSERT INTO VEICULO (ID_VEICULO, MARCA, MODELO, COR, ANO, QUILOMETRAGEM, VALOR_LOCACAO_DIARIO, DISPONIBILIDADE)
VALUES (SEQ_VEICULO.nextval, 'Fiat', 'Uno', 'Verde', 2021, 7000, 120, 'DISPONÍVEL');

INSERT INTO VEICULO (ID_VEICULO, MARCA, MODELO, COR, ANO, QUILOMETRAGEM, VALOR_LOCACAO_DIARIO, DISPONIBILIDADE)
VALUES (SEQ_VEICULO.nextval, 'Volkswagen', 'Taos', 'azul', 2021, 0000, 400, 'DISPONÍVEL');
INSERT INTO VEICULO (ID_VEICULO, MARCA, MODELO, COR, ANO, QUILOMETRAGEM, VALOR_LOCACAO_DIARIO, DISPONIBILIDADE)
VALUES (SEQ_VEICULO.nextval, 'Volkswagen', 'jetta', 'Preto', 2022, 80, 250, 'DISPONÍVEL');
INSERT INTO VEICULO (ID_VEICULO, MARCA, MODELO, COR, ANO, QUILOMETRAGEM, VALOR_LOCACAO_DIARIO, DISPONIBILIDADE)
VALUES (SEQ_VEICULO.nextval, 'hyundai', 'Creta', 'Branco', 2019, 1300, 200, 'DISPONÍVEL');
INSERT INTO VEICULO (ID_VEICULO, MARCA, MODELO, COR, ANO, QUILOMETRAGEM, VALOR_LOCACAO_DIARIO, DISPONIBILIDADE)
VALUES (SEQ_VEICULO.nextval, 'Mercedes-Benz', 'GLB', 'Cinza', 2022, 500, 1200, 'DISPONÍVEL');

INSERT INTO VEICULO (ID_VEICULO, MARCA, MODELO, COR, ANO, QUILOMETRAGEM, VALOR_LOCACAO_DIARIO, DISPONIBILIDADE)
VALUES (SEQ_VEICULO.nextval, 'Chevrolet', 'Corsa Premium', 'Preto', 2009, 56000, 120, 'DISPONÍVEL');
INSERT INTO VEICULO (ID_VEICULO, MARCA, MODELO, COR, ANO, QUILOMETRAGEM, VALOR_LOCACAO_DIARIO, DISPONIBILIDADE)
VALUES (SEQ_VEICULO.nextval, 'Chevrolet', 'Onix', 'Prata', 2016, 98000, 220, 'DISPONÍVEL');
INSERT INTO VEICULO (ID_VEICULO, MARCA, MODELO, COR, ANO, QUILOMETRAGEM, VALOR_LOCACAO_DIARIO, DISPONIBILIDADE)
VALUES (SEQ_VEICULO.nextval, 'Volkswagem', 'Gol G6', 'Vermelho', 2020, 87000, 200, 'DISPONÍVEL');
INSERT INTO VEICULO (ID_VEICULO, MARCA, MODELO, COR, ANO, QUILOMETRAGEM, VALOR_LOCACAO_DIARIO, DISPONIBILIDADE)
VALUES (SEQ_VEICULO.nextval, 'Renault', 'Clio', 'Branco', 2010, 70000, 130, 'DISPONÍVEL');
...
VALUES (SEQ_CLIENTE.nextval, 'Thiago', '85226595885', 1, 2);
INSERT INTO CLIENTE (ID_CLIENTE, NOME, CPF, ID_CONTATO, ID_ENDERECO)
...
VALUES (SEQ_CARTAO_CREDITO.nextval, '9999 8888 7777 6666', 'VISA', '05/2030', '50000');
INSERT INTO CARTAO_CREDITO (ID_CARTAO, NUMERO, BANDEIRA_CARTAO, VALIDADE, LIMITE)
...
VALUES (SEQ_LOCACAO.nextval, TO_DATE ('05-03-2022','dd-mm-yyyy'), TO_DATE ('10-03-2022','dd-mm-yyyy'), 50, 1100, 1, 1, 2, 1);
INSERT INTO LOCACAO(ID_LOCACAO, DATA_LOCACAO, DATA_DEVOLUCAO, QUILOMETRAGEM_ADICAO, VALOR_LOCACAO_TOTAL, ID_CLIENTE, ID_VEICULO, ID_FUNCIONARIO, ID_CARTAO)
VALUES (SEQ_LOCACAO.nextval, TO_DATE ('10-03-2022','dd-mm-yyyy'), TO_DATE ('12-03-2022','dd-mm-yyyy'), 25, 320, 2, 2, 2, 2);
INSERT INTO LOCACAO(ID_LOCACAO, DATA_LOCACAO, DATA_DEVOLUCAO, QUILOMETRAGEM_ADICAO, VALOR_LOCACAO_TOTAL, ID_CLIENTE, ID_VEICULO, ID_FUNCIONARIO, ID_CARTAO)
VALUES (SEQ_LOCACAO.nextval, TO_DATE ('10-03-2022','dd-mm-yyyy'), TO_DATE ('20-03-2022','dd-mm-yyyy'), 50, 2200, 3, 3, 1, 3);
INSERT INTO LOCACAO(ID_LOCACAO, DATA_LOCACAO, DATA_DEVOLUCAO, QUILOMETRAGEM_ADICAO, VALOR_LOCACAO_TOTAL, ID_CLIENTE, ID_VEICULO, ID_FUNCIONARIO, ID_CARTAO)
VALUES (SEQ_LOCACAO.nextval, TO_DATE ('05-03-2022','dd-mm-yyyy'), TO_DATE ('06-03-2022','dd-mm-yyyy'), 25, 120, 4, 4, 3, 4);
